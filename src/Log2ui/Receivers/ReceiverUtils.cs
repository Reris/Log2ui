...
public static class ReceiverUtils
{
    ...
    /// </summary>
    private static readonly XmlReaderSettings XmlSettings = ReceiverUtils.CreateSettings();
    ...
    public static LogMessage ParseLog4JXmlLogEvent(XmlReader reader)
    {
        ...
        {
            logMsg.TimeStamp = ReceiverUtils.UnixEpoch.AddMilliseconds(timeStamp).ToLocalTime();
        }
