...
public interface IEditableCollectionView<TItem, out TCollection> : ICollectionView<TItem, TCollection>
...
public interface IEditableCollectionView<TItem> : IEditableCollectionView<TItem, ObservableCollection<TItem>>, ICollectionView<TItem>
{
}
